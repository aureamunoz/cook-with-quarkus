...
public class NutrientRepository {
    ...
    void init() {
        ...
        nutrientDatabase.put("spaghetti", new NutritionalInfo( "spaghetti",742,
                ...
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN)));
        ...
        nutrientDatabase.put("huevo", new NutritionalInfo("huevo",123,
                ...
                List.of(NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED, NutrionFactsResponse.HealthLabel.GLUTEN_FREE, NutrionFactsResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("panceta", new NutritionalInfo("panceta",393,
                ...
                List.of(NutrionFactsResponse.HealthLabel.GLUTEN_FREE)));
        ...
        nutrientDatabase.put("pimienta negra", new NutritionalInfo("pimienta negra",0,
                ...
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED, NutrionFactsResponse.HealthLabel.GLUTEN_FREE, NutrionFactsResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("levadura", new NutritionalInfo("levadura",16,
                ...
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED, NutrionFactsResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("lechuga", new NutritionalInfo("lechuga",26,
                List.of(new Nutrient("Protein", 2.7, "g"),
                        ...
                        new Nutrient("Fat", 0.4, "g")),
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED, NutrionFactsResponse.HealthLabel.DAIRY_FREE, NutrionFactsResponse.HealthLabel.GLUTEN_FREE)));

        nutrientDatabase.put("pollo", new NutritionalInfo("pollo",323,
                List.of(new Nutrient("Protein", 27.9, "g"),
                        new Nutrient("Carbohydrates", 0 , "g"),
                        new Nutrient("Fat", 22.7, "g")),
                List.of(NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED, NutrionFactsResponse.HealthLabel.DAIRY_FREE, NutrionFactsResponse.HealthLabel.GLUTEN_FREE)));
        ...
        nutrientDatabase.put("crutones", new NutritionalInfo("crutones",204,
                ...
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("calabaza", new NutritionalInfo("calabaza",130,
                List.of(new Nutrient("Protein", 5, "g"),
                        ...
                        new Nutrient("Fat", 0.5, "g")),
                List.of(NutrionFactsResponse.HealthLabel.VEGAN, NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.DAIRY_FREE, NutrionFactsResponse.HealthLabel.GLUTEN_FREE, NutrionFactsResponse.HealthLabel.NO_SUGAR_ADDED)));
        ...
        nutrientDatabase.put("nata", new NutritionalInfo("nata",343,
                List.of(new Nutrient("Protein", 36.4, "g"),
                        ...
                        new Nutrient("Fat", 0, "g")),
                List.of( NutrionFactsResponse.HealthLabel.VEGETARIAN, NutrionFactsResponse.HealthLabel.GLUTEN_FREE)));
    }


    public NutrionFactsResponse nutritionFacts(List<String> ingredients) {
        int totalCalories = 0;
        Map<String, Nutrient> nutrientMap = new HashMap<>();
        Set<NutrionFactsResponse.HealthLabel> totalHealthLabels = new HashSet<>();
        ...
        return new NutrionFactsResponse(totalCalories, new ArrayList<>(totalHealthLabels), totalNutrients);
    }
