    ...
    void init() {
        ...
        nutrientDatabase.put("spaghetti",
                new NutritionalFacts("spaghetti", 742,
                        List.of(new Nutrient("Grasas", 3, "g"), new Nutrient("Hidratos de Carbono", 149.4f, "g"),
        ...
        nutrientDatabase.put("huevo",
                new NutritionalFacts("huevo", 123,
                        List.of(new Nutrient("Proteinas", 10.8f, "g"), new Nutrient("Hidratos de Carbono", 0.6f, "g"),
                                new Nutrient("Grasas", 8.2f, "g")),
        ...
        nutrientDatabase.put("panceta",
                new NutritionalFacts("panceta", 393,
                        List.of(new Nutrient("Proteinas", 13.7f, "g"), new Nutrient("Hidratos de Carbono", 0, "g"),
                                new Nutrient("Grasas", 37.1f, "g")),
                        List.of(NutriPicResponse.HealthLabel.GLUTEN_FREE)));

        nutrientDatabase.put("queso parmesano",
                new NutritionalFacts("queso parmesano", 196,
                        List.of(new Nutrient("Proteinas", 17.9f, "g"), new Nutrient("Hidratos de Carbono", 1.6f, "g"),
                                new Nutrient("Grasas", 12.5f, "g")),
                        List.of(NutriPicResponse.HealthLabel.GLUTEN_FREE)));
        ...
        nutrientDatabase.put("sal",
                new NutritionalFacts("sal", 0, List.of(new Nutrient("Sodium", 147.5f, "mg")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED, NutriPicResponse.HealthLabel.GLUTEN_FREE,
                                NutriPicResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("harina",
                new NutritionalFacts("harina", 1092,
                        List.of(new Nutrient("Proteinas", 30.9f, "g"), new Nutrient("Hidratos de Carbono", 228.9f, "g"),
                                new Nutrient("Grasas", 2.9f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN)));
        ...
        nutrientDatabase.put("levadura",
                new NutritionalFacts("levadura", 16,
                        List.of(new Nutrient("Proteinas", 2, "g"), new Nutrient("Hidratos de Carbono", 2.1f, "g"),
                                new Nutrient("Grasas", 0.4f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
        ...
        nutrientDatabase.put("tomate",
                new NutritionalFacts("tomate", 36,
                        List.of(new Nutrient("Proteinas", 1.8f, "g"), new Nutrient("Hidratos de Carbono", 8, "g"),
                                new Nutrient("Grasas", 0.5f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED, NutriPicResponse.HealthLabel.DAIRY_FREE)));

        nutrientDatabase.put("mozarella",
                new NutritionalFacts("mozarella", 299,
                        List.of(new Nutrient("Proteinas", 22.2f, "g"), new Nutrient("Hidratos de Carbono", 2.4f, "g"),
                                new Nutrient("Grasas", 22.1f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED, NutriPicResponse.HealthLabel.DAIRY_FREE)));

        nutrientDatabase.put("albahaca",
                new NutritionalFacts("albahaca", 2,
                        List.of(new Nutrient("Proteinas", 0.3f, "g"), new Nutrient("Hidratos de Carbono", 0.3f, "g"),
                                new Nutrient("Grasas", 0.1f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED, NutriPicResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("lechuga",
                new NutritionalFacts("lechuga", 26,
                        List.of(new Nutrient("Proteinas", 2.7f, "g"), new Nutrient("Hidratos de Carbono", 4.5f, "g"),
                                new Nutrient("Grasas", 0.4f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED, NutriPicResponse.HealthLabel.DAIRY_FREE,
        ...
        nutrientDatabase.put("pollo",
                new NutritionalFacts("pollo", 323,
                        List.of(new Nutrient("Proteinas", 27.9f, "g"), new Nutrient("Hidratos de Carbono", 0, "g"),
                                new Nutrient("Grasas", 22.7f, "g")),
        ...
        nutrientDatabase.put("crutones",
                new NutritionalFacts("crutones", 204,
                        List.of(new Nutrient("Proteinas", 6, "g"), new Nutrient("Hidratos de Carbono", 36.8f, "g"),
                                new Nutrient("Grasas", 3.3f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.DAIRY_FREE)));
        ...
        nutrientDatabase.put("calabaza",
                new NutritionalFacts("calabaza", 130,
                        List.of(new Nutrient("Proteinas", 5, "g"), new Nutrient("Hidratos de Carbono", 32.5f, "g"),
                                new Nutrient("Grasas", 0.5f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
        ...
        nutrientDatabase.put("cebolla",
                new NutritionalFacts("cebolla", 80,
                        List.of(new Nutrient("Proteinas", 2.2f, "g"), new Nutrient("Hidratos de Carbono", 18.7f, "g"),
                                new Nutrient("Grasas", 0.2f, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.DAIRY_FREE, NutriPicResponse.HealthLabel.GLUTEN_FREE,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED)));
        ...
        nutrientDatabase.put("caldo de verduras",
                new NutritionalFacts("caldo de verduras", 86,
                        List.of(new Nutrient("Proteinas", 1.4f, "g"), new Nutrient("Hidratos de Carbono", 1.2f, "g"),
        ...
        nutrientDatabase.put("jenjibre",
                new NutritionalFacts("jenjibre", 4,
                        List.of(new Nutrient("Proteinas", 0.1f, "g"), new Nutrient("Hidratos de Carbono", 0.9f, "g"),
                                new Nutrient("Grasas", 0, "g")),
                        List.of(NutriPicResponse.HealthLabel.VEGAN, NutriPicResponse.HealthLabel.VEGETARIAN,
                                NutriPicResponse.HealthLabel.DAIRY_FREE, NutriPicResponse.HealthLabel.GLUTEN_FREE,
                                NutriPicResponse.HealthLabel.NO_SUGAR_ADDED)));
        ...
        nutrientDatabase.put("nata",
                new NutritionalFacts("nata", 343,
                        List.of(new Nutrient("Proteinas", 36.4f, "g"), new Nutrient("Hidratos de Carbono", 2.9f, "g"),
                                new Nutrient("Grasas", 0, "g")),
            ...
            if (info != null) {
                ...
                for (Nutrient nutrient : info.nutrients()) {
                    ...
                    if (existing != null) {
                        ...
                        float newQuantity = existing.getQuantity() + nutrient.getQuantity();
